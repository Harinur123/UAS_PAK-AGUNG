...
<html>
  <head>
    ...
    <title>PENCATATAN PENERIMAAN DAN PENGELUARAN KAS | PT. PGN INDONESIA CABANG CIREBON</title>
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="#" class="navbar-brand"><b>PT. PGN INDONESIA CABANG CIREBON</b></a>
      ...
      <footer class="main-footer">
        <div class="container">
          ...
          <strong>Copyright &copy; 2017 <a href="#">PT. PGN INDONESIA CABANG CIREBON</a></strong>
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
